...
CREATE TABLE `letters` (
  ...
  `no_sp2dk` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `potensi_akhir` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `realisasi` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
