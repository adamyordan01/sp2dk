...
class SendToSukiImport implements ToCollection, WithHeadingRow, SkipsOnError, WithValidation, SkipsOnFailure
{
    /**
    * @param array $row
    *
    ...
    */
    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $row) {
            ...
            $letter->tanggal_kirim_suki = empty($row['tgl_kirim_ke_suki']) ? $row['tgl_kirim_ke_suki'] : $this->transformDate($row['tgl_kirim_ke_suki']);
