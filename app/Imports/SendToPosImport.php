...
class SendToPosImport implements ToCollection, WithHeadingRow, SkipsOnError, WithValidation, SkipsOnFailure
{
    /**
    * @param array $row
    *
    ...
    */
    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $row) {
            ...
            $letter->tanggal_kirim_pos = empty($row['tgl_kirim_pos']) ? $row['tgl_kirim_pos'] : $this->transformDate($row['tgl_kirim_pos']);
