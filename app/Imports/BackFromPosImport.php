...
class BackFromPosImport implements ToCollection, WithHeadingRow, SkipsOnError, WithValidation, SkipsOnFailure
{
    /**
    * @param array $row
    *
    ...
    */
    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $row) {
            ...
            $letter->tanggal_kempos = empty($row['tgl_kempos']) ? $row['tgl_kempos'] : $this->transformDate($row['tgl_kempos']);
